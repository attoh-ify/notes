...
//        }
    ...
    private String buildRoleBadge(NoteAccessRole role) {
        ...
        switch (role) {
            case VIEWER:
                description = "Read-only access. Stay in the loop with live updates.";
                break;
            case EDITOR:
                description = "Collaborator access. Edit content in real-time with the team.";
                break;
            case SUPER:
                description = "Administrative access. Edit content and manage collaborator permissions.";
                break;
            default:
                description = "Collaborator access granted.";
                break;
        };
