...
import com.crowninteractive.notes.notifier.CursorNotifier;
import com.crowninteractive.notes.notifier.SoloSyncNotifier;
...
public class CollaborationSocketController {
    ...
    private void requireJoinedNote(
        ...
        if (joinedNoteId == null || !noteId.equals(String.valueOf(joinedNoteId))) {
